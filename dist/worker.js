(() => {
  ...
  function useRoutes(routes3, locationArg) {
...
` + ('Please change the parent <Route path="' + parentPath + '"> to <Route ') + ('path="' + (parentPath === "/" ? "*" : parentPath + "/*") + '">.'));
    ...
    let matches = matchRoutes(routes3, {
  ...
  function matchRoutes(routes3, locationArg, basename) {
    if (basename === void 0) {
      basename = "/";
    }
...
${String(error)}`;
  ...
  function createRequestHandler2({
    ...
    let platform = {};
    let handleRequest2 = createRequestHandler(build, platform, mode);
    return (context) => {
  ...
  function createPagesFunctionHandler({
    ...
    const handleRequest2 = createRequestHandler2({
      build,
      getLoadContext,
      mode
    });
  ...
  var import_server3 = __toModule(require_server_browser());
  ...
  function matchClientRoutes(routes3, location) {
    let matches = matchRoutes(routes3, location);
    if (!matches)
      return null;
    return matches.map((match) => ({
      params: match.params,
...
If you were trying to navigate or submit to a resource route, use \`<a>\` instead of \`<Link>\` or \`<Form reloadDocument>\`.`);
  ...
  function Meta() {
    ...
    return /* @__PURE__ */ React2.createElement(React2.Fragment, null, Object.entries(meta2).map(([name, value]) => {
      ...
      return name === "title" ? /* @__PURE__ */ React2.createElement("title", {
        key: "title"
      }, value) : Array.isArray(value) ? value.map((content) => isOpenGraphTag ? /* @__PURE__ */ React2.createElement("meta", {
        key: name + content,
        property: name,
        content
        ...
        name,
        content
      })) : isOpenGraphTag ? /* @__PURE__ */ React2.createElement("meta", {
        key: name,
        property: name,
        content: value
      }) : /* @__PURE__ */ React2.createElement("meta", {
...
window.__remixRouteModules = {${matches.map((match, index) => `${JSON.stringify(match.route.id)}:route${index}`).join(",")}};`;
  ...
  // build/assets.json
  var version = "852e4f4b";
  var entry = {
    module: "/build/entry.client-DECLSQEA.js",
    imports: [
      "/build/_shared/chunk-Z5U7UXTY.js",
  ...
  var routes = {
    ...
    "routes/index": {
      ...
      parentId: "root",
      index: true,
      module: "/build/routes/index-PG3X76P5.js",
      hasAction: false,
      hasLoader: false,
      hasCatchBoundary: false,
      hasErrorBoundary: false
  ...
  var url = "/build/manifest-852E4F4B.js";
  var assets_default = {
    version,
    entry,
    routes,
  ...
  function handleRequest(request, responseStatusCode, responseHeaders, remixContext) {
    const markup = (0, import_server3.renderToString)(/* @__PURE__ */ React5.createElement(RemixServer, {
  ...
  function App() {
    ...
    }), /* @__PURE__ */ React5.createElement(Meta, null), /* @__PURE__ */ React5.createElement(Links, null)), /* @__PURE__ */ React5.createElement("body", null, /* @__PURE__ */ React5.createElement(Outlet, null), /* @__PURE__ */ React5.createElement(ScrollRestoration, null), /* @__PURE__ */ React5.createElement(Scripts, null), /* @__PURE__ */ React5.createElement(LiveReload, null)));
  }
  var routes_exports = {};
  ...
  function Index() {
    ...
    }, /* @__PURE__ */ React5.createElement("h1", null, "Welcome to Remix"), /* @__PURE__ */ React5.createElement("ul", null, /* @__PURE__ */ React5.createElement("li", null, /* @__PURE__ */ React5.createElement("a", {
      target: "_blank",
      href: "https://remix.run/tutorials/blog",
      rel: "noreferrer"
    }, "15m Quickstart Blog Tutorial")), /* @__PURE__ */ React5.createElement("li", null, /* @__PURE__ */ React5.createElement("a", {
      target: "_blank",
      href: "https://remix.run/tutorials/jokes",
      rel: "noreferrer"
    }, "Deep Dive Jokes App Tutorial")), /* @__PURE__ */ React5.createElement("li", null, /* @__PURE__ */ React5.createElement("a", {
      target: "_blank",
  ...
  // worker/index.js
  addEventListener("fetch", createPagesFunctionHandler({ build: build_exports }));
})();
/*
object-assign
(c) Sindre Sorhus
...
*/
/**
 * @remix-run/cloudflare-pages v1.1.1
 *
